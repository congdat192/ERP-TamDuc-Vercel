...
export function CreateTemplateModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: 'Thành công',
        description: 'Đã tạo mẫu văn bản',
      });
      onSuccess();
      onClose();
      setFormData({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-6xl max-h-[90vh] overflow-hidden flex flex-col">
        <DialogHeader>
          <DialogTitle>Tạo Mẫu Văn Bản Mới</DialogTitle>
        </DialogHeader>
            ...
            <div className="col-span-2 space-y-4 overflow-y-auto pr-4">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  placeholder="Nhập nội dung mẫu văn bản. Sử dụng {{placeholder}} để chèn trường dữ liệu động."
