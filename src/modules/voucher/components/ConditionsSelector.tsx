...
export function ConditionsSelector({ value, onChange }: ConditionsSelectorProps) {
  ...
  return (
    <div className="space-y-4">
      <h3 className="text-lg font-semibold text-gray-900">Điều Kiện Sử Dụng</h3>
      <Card>
        <CardContent className="p-6 space-y-4">
          {/* Quick add common conditions */}
          <div className="space-y-2">
            <h4 className="text-sm font-medium text-gray-700">Điều kiện phổ biến:</h4>
          ...
          <div className="space-y-2">
            <h4 className="text-sm font-medium text-gray-700">Thêm điều kiện tùy chỉnh:</h4>
          ...
          {value.length > 0 && (
            <div className="space-y-2">
              <h4 className="text-sm font-medium text-gray-700">Điều kiện đã chọn:</h4>
              <div className="space-y-2">
