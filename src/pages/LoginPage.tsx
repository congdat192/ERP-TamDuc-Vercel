  ...
  const mockUsers = [
    {
      ...
      emailVerified: true,
      permissions: {
        modules: ['dashboard', 'customers', 'sales', 'inventory', 'accounting', 'hr', 'voucher', 'system-settings', 'user-management'] as any[],
        canManageUsers: true,
    ...
    },
    {
      ...
      permissions: {
        ...
        voucherFeatures: ['issue-voucher', 'voucher-list'] as any[],
      },
      securitySettings: {
        twoFactorEnabled: false,
        loginAttemptLimit: 3,
