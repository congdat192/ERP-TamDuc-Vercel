...
import { TrendingUp, TrendingDown, AlertCircle, Building2, Wallet, Landmark } from 'lucide-react';
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm">
                        <h3 className="text-sm font-semibold text-gray-700 mb-4 flex items-center gap-2 uppercase tracking-wide">
                            <LayoutDashboardIcon size={16} className="text-gray-500" /> Sổ Quỹ Khối Chi Nhánh
                        </h3>
                        <div className="grid grid-cols-2 gap-4">
...
// Helper component for icon since LayoutDashboard is not imported
const LayoutDashboardIcon = ({ size, className }: { size: number, className?: string }) => (
